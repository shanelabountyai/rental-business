    ...
    <div className="flex flex-col gap-6">
      ...
      <RuleForm
        ...
        defaults={{
          ...
          earlyTerminationRightExists: previous?.earlyTerminationRightExists ?? null,
          earlyTerminationNoticeDays: previous?.earlyTerminationNoticeDays ?? '',
          earlyTerminationDocumentationTypes: previous?.earlyTerminationDocumentationTypes ?? [],
