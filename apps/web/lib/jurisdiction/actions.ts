...
function ruleInputFrom(formData: FormData): JurisdictionRuleInput {
  return {
    ...
    cureDemandMayIncludeFees: optionalBoolean(formData, 'cureDemandMayIncludeFees'),
    partialPaymentCures: optionalBoolean(formData, 'partialPaymentCures'),
  ...
  await prisma.$transaction(async (tx) => {
    ...
    const created = await tx.jurisdictionRule.create({
      data: {
        ...
        cureDemandMayIncludeFees: input.cureDemandMayIncludeFees,
        partialPaymentCures: input.partialPaymentCures,
