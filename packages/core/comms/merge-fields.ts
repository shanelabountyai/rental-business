...
export const MERGE_FIELDS: readonly MergeField[] = [
  ...
  { key: 'lease.starts_on', label: 'Lease start date', example: '1 Jan 2026' },
  { key: 'lease.ends_on', label: 'Lease end date', example: '31 Dec 2026' },
  { key: 'balance.total', label: 'What the tenant owes today', example: '$1,500.00' },
  { key: 'balance.due_on', label: 'Date the balance is due', example: '1 Sept 2026' },
  { key: 'today', label: "Today's date, in the property's timezone", example: '15 Aug 2026' },
